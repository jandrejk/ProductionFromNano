...
// Thu Feb 14 13:12:14 2019 by ROOT version 6.12/07
// from TTree Events/Events
// found on file: nano_0.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           GenPart_genPartIdxMother[127];   //[nGenPart]
   Int_t           GenPart_pdgId[127];   //[nGenPart]
   Int_t           GenPart_status[127];   //[nGenPart]
   Int_t           GenPart_statusFlags[127];   //[nGenPart]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("nano_0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("nano_0.root");
      }
...
void NanoEventsSkeleton::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("HLT_Ele24_eta2p1_WPTight_Gsf_LooseChargedIsoPFTaS30_eta2p1_CrossL1", &HLT_Ele24_eta2p1_WPTight_Gsf_LooseChargedIsoPFTau30_eta2p1_CrossL1, &b_HLT_Ele24_eta2p1_WPTight_Gsf_LooseChargedIsoPFTauHPS30_eta2p1_CrossL1);
