...
void HTauTauTreeFromNanoBase::initHTTTree(const TTree *tree, std::string prefix)
{
    ...
    HTTEvent::usePropertyFor["tauIsolation"]       = PropertyEnum::rawDeepTau2017v2VSjet;
    HTTEvent::usePropertyFor["tauID"]              = PropertyEnum::idDeepTau2017v2VSjet;
    ...
    HTTEvent::usePropertyFor["tauIsolationDeepVSmu"]        = PropertyEnum::rawDeepTau2017v2VSmu; // technically not needed
    HTTEvent::usePropertyFor["tauIDDeepVSmu"]               = PropertyEnum::idDeepTau2017v2VSmu;
    // anti-ele (against-ele) discriminator
    HTTEvent::usePropertyFor["tauIsolationDeepVSele"]       = PropertyEnum::rawDeepTau2017v2VSe; // technically not needed
...
void HTauTauTreeFromNanoBase::fillLeptons()
{
    ...
    for(unsigned int iTau=0; iTau<nTau; ++iTau)
    {
        ...
        // if( Tau_decayMode[iTau] == 5 || Tau_decayMode[iTau] == 6) {
        //     std::cout<<"event id "<<event<<std::endl;
        //     std::cout<< "found DM 5/6 :" << Tau_decayMode[iTau] << std::endl;
        // }
        ...
        // std::cout<<"event " << event << " passed DM" << std::endl;
        // std::cout<<"event DM  " << Tau_decayMode[iTau] << std::endl;
        // if( Tau_decayMode[iTau] < 4 || Tau_decayMode[iTau] > 7 ) continue;
        
        // std::cout<<"found DM 5 or 6 " << Tau_decayMode[iTau] << std::endl;
